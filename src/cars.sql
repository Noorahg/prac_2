...
select sum(price) from cars where brand like 'Mercedes-Benz';--12--
select max(price) ,min(price) from cars;
select brand from cars where cars.brand not like 'Toyota';
select price from  cars order by price desc limit 10;
select * from cars order by year_of_issue desc limit 15 offset 5;--16--
